    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light portlet-fit bordered">
            ...
            <div class="portlet-body ">
                <div class="row ">
                    <div class="col-md-4 ">
                        <img src="<%=request.getContextPath() %>/static/pages/img/course/springboot.jpg" width="233px"
                ...
                <div class="row " style="margin-top: 10px;">
                    <div class="col-md-4 ">
                        <img src="<%=request.getContextPath() %>/static/pages/img/course/zookeeper.jpg" width="233px"
                             class="img-responsive"/>
                    </div>
                    <div class="col-md-8 ">
                        <h4><a href="https://coding.imooc.com/class/201.html" target="_blank">《ZooKeeper分布式专题与Dubbo微服务入门》</a>
                        </h4>
                    </div>
                </div>
            </div>
